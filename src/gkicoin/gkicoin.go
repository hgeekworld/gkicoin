...
import (
	...
	"hgeekl.com/gkicoin/src/api"
	"hgeekl.com/gkicoin/src/cipher"
	"hgeekl.com/gkicoin/src/coin"
	"hgeekl.com/gkicoin/src/daemon"
	"hgeekl.com/gkicoin/src/util/apputil"
	"hgeekl.com/gkicoin/src/util/browser"
	"hgeekl.com/gkicoin/src/util/cert"
	"hgeekl.com/gkicoin/src/util/logging"
	"hgeekl.com/gkicoin/src/visor"
	"hgeekl.com/gkicoin/src/visor/dbutil"
	"hgeekl.com/gkicoin/src/wallet"
)
...
func (c *Coin) Run() {
	...
	if err != nil {
		c.logger.Errorf("Database failed to open: %v. Is another gkicoin instance running?", err)
		return
	}
...
func (c *Coin) createGUI(d *daemon.Daemon, host string) (*api.Server, error) {
	...
	if c.config.Node.WebInterfaceHTTPS {
		...
		if err := cert.CreateCertIfNotExists(host, c.config.Node.WebInterfaceCert, c.config.Node.WebInterfaceKey, "Gkicoind"); err != nil {
...
func InitTransaction() coin.Transaction {
	...
	output := cipher.MustSHA256FromHex("f33d06305a39438c23137d54fd3c3ce06322e70dc282dfca81b658d96961a5b6")
	tx.PushInput(output)
	...
	sig := "9bd671bc061d9e321b86c7c55ecd36676067450bcde3025dc96cfa9b32e3d581395226414b14852e52f42eb8376c41b4c1fa5c91f144a5540d8a2ef6d5298b8401"
