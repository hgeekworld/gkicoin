...
import (
	...
	"hgeekl.com/gkicoin/src/util/file"
...
// Config records gkicoin node and build config
type Config struct {
	Node  NodeConfig
...
type NodeConfig struct {
	...
	// Data directory holds app data -- defaults to ~/.gkicoin
...
func (c *Config) register() {
	...
	flag.StringVar(&c.Node.DataDirectory, "data-dir", c.Node.DataDirectory, "directory to store app data (defaults to ~/.gkicoin)")
	flag.StringVar(&c.Node.DBPath, "db-path", c.Node.DBPath, "path of database file (defaults to ~/.gkicoin/data.db)")
	...
	flag.StringVar(&c.Node.WalletDirectory, "wallet-dir", c.Node.WalletDirectory, "location of the wallet files. Defaults to ~/.gkicoin/wallet/")
