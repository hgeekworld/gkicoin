...
import (
	...
	logging "hgeekl.com/gkicoin/src/util/logging"
)
...
// FromString converts a gkicoin balance string with decimal places to uint64 droplets.
...
func FromString(b string) (uint64, error) {
	...
	// Gkicoins have a maximum of 6 decimal places
...
// ToString converts droplets to a gkicoin balance fixed-point decimal string.
