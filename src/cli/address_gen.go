...
import (
	...
	bip39 "hgeekl.com/gkicoin/src/cipher/go-bip39"
...
func addressGenCmd() gcli.Command {
	...
	return gcli.Command{
		Name:        name,
		Usage:       "Generate gkicoin or bitcoin addresses",
		Description: "",
		Flags: []gcli.Flag{
			gcli.IntFlag{
				Name:  "count,c",
			...
			gcli.BoolFlag{
				Name:  "bitcoin,b",
				Usage: "Output the addresses as bitcoin addresses instead of gkicoin addresses",
			},
			gcli.BoolFlag{
				Name:  "hex,x",
		...
		Action: func(c *gcli.Context) error {
			...
			if c.Bool("bitcoin") {
				...
				coinType = wallet.CoinTypeGkicoin
			}
